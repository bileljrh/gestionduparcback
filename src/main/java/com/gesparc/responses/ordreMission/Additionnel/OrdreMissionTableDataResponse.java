package com.gesparc.responses.ordreMission.Additionnel;
...
import com.gesparc.responses.ordreMission.AccompagnonMissionResponse;


@Data
@NoArgsConstructor
@AllArgsConstructor
public class OrdreMissionTableDataResponse implements Serializable {
    List<AccompagnonMissionResponse> accompagnons = new ArrayList<>();
    private Long id;
